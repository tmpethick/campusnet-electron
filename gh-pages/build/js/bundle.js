...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reqwest = __webpack_require__(299);

	var _reqwest2 = _interopRequireDefault(_reqwest);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var DOWNLOAD_URL = 'https://github.com/tmpethick/campusnet-electron/releases/latest';
	...
	(0, _reqwest2.default)({
	  ...
	  success: function success(resp) {
	    ...
	    var version = getPlatformLink(release);
	    if (version) {
	      Array.prototype.forEach.call(document.querySelectorAll('.js-download'), function ($el) {
	        return $el.setAttribute('href', version.link);
	      });
	      var $notice = document.querySelector('.js-download-notice');
	...
	var getPlatformLink = function getPlatformLink(release) {
	  if (isMac()) {
	    var asset = release.assets.find(function (a) {
	      return a.browser_download_url.endsWith('.dmg');
	    });
	    return {
	      platform: 'Mac OS X',
